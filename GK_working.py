    ...
    def check_rounds(self):
        ...
        try:
            ...
            if rounds_wanted > 0:
                ...
                # Clear entry box (so if users return to
                # the main screen, they can enter a new number of rounds)
                # and go to play GUI
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        self.end_game_button = Button(self.game_frame, font=("Arial", "16", "bold"),
                                      text="End Game", image=self.chicken_image, compound="right",
                                      bg="#990000", fg="#FFFFFF", width=200, command=self.close_play)
