...
class Play:
    ...
    def new_round(self):
        ...
        # It will be 0 at the start, we need to make it '+1' in the heading
    ...
    def round_results(self, user_choice):
        ...
        if score >= target:
            ...
            # Adjust # of rounds won (for stats / editing label at end of game)
            rounds_won += 1
    ...
    def to_hints(self):
        """
        Displays hints for playing game.  Prevents users from accessing
