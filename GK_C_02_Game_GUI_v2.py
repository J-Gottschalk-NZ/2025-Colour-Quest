...
class Play:
    ...
    def __init__(self, how_many):
        ...
        for item in play_labels_list:
            self.make_label = Label(self.game_frame, text=item[0], font=item[1],
                                    bg=item[2], wraplength=300, justify="left", padx=5, pady=5)
    ...
    def new_round(self):
        ...
        # disable next button (until colour has been chosen)
    ...
    def round_results(self, user_choice):
        ...
        # add score and median to lists for stats
